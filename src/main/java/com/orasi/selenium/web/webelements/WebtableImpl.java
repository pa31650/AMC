 ...
 */
public class WebtableImpl extends Webelement implements Table {
    ...
    public Element getCell(int row, int column) {
        ...
        getWrappedDriver().setElementTimeout(1, TimeUnit.SECONDS);
        Element cell = new Webelement(getWrappedDriver(), By.xpath(getElementIdentifier() + "/tbody/tr[" + row + "]/td[" + column + "]|" + getElementIdentifier() + "/tbody/tr[" + row + "]/th[" + column
