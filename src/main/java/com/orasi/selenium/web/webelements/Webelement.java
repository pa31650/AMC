...
import static com.orasi.selenium.OrasiDriver.DEFAULT_SYNC_HANDLER;
...
import com.orasi.selenium.exceptions.ElementNotFoundInFrameException;
...
import com.orasi.selenium.web.ExtendedExpectedConditions;
...
public class Webelement implements Element {
    ...
    public Webelement(final WebElement element) {
    ...
    public Webelement(final OrasiDriver driver, final By by) {
        this.by = by;
        this.driver = driver;
        try {
    ...
    public Webelement(final OrasiDriver driver, final ByNG by) {
        this.byNG = by;
        this.driver = driver;
        try {
            logTrace("Entering ElementImpl#init");
