...
public class UIException extends AutomationException {
    ...
    public UIException(String message, WebDriver driver) {
        super("Automation Error: " + message);
        this.driver = driver;
    }

    public UIException(String message, OrasiDriver driver) {
        super("Automation Error: " + message);
